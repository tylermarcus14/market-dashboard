...
import { marketSnapshots, markets } from "../lib/db/schema";
import { fetchGammaMarkets } from "../lib/polymarket/gamma";
...
async function main() {
  ...
  console.log(
    `Ingested ${marketRows.length} markets and ${snapshotRows.length} snapshots`,
  );
}
